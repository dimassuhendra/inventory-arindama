...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">    <script src="https://cdn.tailwindcss.com"></script>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    fontFamily: { dynapuff: ['Poppins'], acme: ['Acme'] },
