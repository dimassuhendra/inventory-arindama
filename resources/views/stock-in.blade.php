    ...
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-blue-100/70 font-domine uppercase tracking-widest mt-1">Kelola Riwayat Stok Masuk</p>
            </div>
    ...
    <div id="modalStockIn"
        ...
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all">
            <div class="bg-arindama p-6 text-white flex justify-between items-center">
                <h3 id="modalTitle" class="font-bold text-lg font-domine tracking-wide">INPUT STOK MASUK</h3>
